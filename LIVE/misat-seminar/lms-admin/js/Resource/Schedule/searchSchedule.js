...
/*function setListData(str){
    ...
    for(var i = 0; i<obj.entry.length;i++){
        ...
        str = str + '<div class="Tool"><ul class="L2s"><li class="L2 i1"><div class="'+ id + ' Btn Detail Title">V</div></li><li class="L2 i1"><div class="'+ id + ' Btn Edit Title">Edit</div></li></ul></div>';
