...
$(document).ready(function(){
	...
	if(loginData==null) {
		...
		if (id){
			getResource(FHIRURL, 'Schedule', '?actor=PractitionerRole/' + id, FHIRResponseType, 'setScheduleListData');
		}
		else
...
document.querySelector('.Btn.Add.Schedule').onclick = function () {
    sessionStorage.setItem('practRoleID', id);
...
function setScheduleListData(str) {
	...
	tablePagination("List-Schedule", 5);
