...
function getFHIRMyCourse(jsonOBJ, type){	//我的課程
	if (type=="Patient"){
		...
		tableValue[iOrganization][index][index1][2]= jsonOBJ.appointmentType.coding[0].display;
		tableValue[iOrganization][index][index1][3] = jsonOBJ.appointmentType.coding[0].code;			//courseMaterial
		arrSchedule[index][5]++;
		iSlot++;
