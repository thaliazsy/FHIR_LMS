...
function setDetailData(str) {
    ...
    document.getElementById('Detail').getElementsByClassName('ServiceCategory')[0].getElementsByClassName('Value')[0].textContent = (obj.serviceCategory && obj.serviceCategory[0].coding[0].display)? obj.serviceCategory[0].coding[0].display : '';
    document.getElementById('Detail').getElementsByClassName('ServiceType')[0].getElementsByClassName('Value')[0].textContent = (obj.serviceType && obj.serviceType[0].coding[0].display) ? obj.serviceType[0].coding[0].display : '';
    document.getElementById('Detail').getElementsByClassName('Specialty')[0].getElementsByClassName('Value')[0].textContent = (obj.specialty && obj.specialty[0].coding[0].display) ? obj.specialty[0].coding[0].display : '';
    document.getElementById('Detail').getElementsByClassName('Actor')[0].getElementsByClassName('Value')[0].textContent = obj.actor ? obj.actor[0].display : '';
    document.getElementById('Detail').getElementsByClassName('StartDate')[0].getElementsByClassName('Value')[0].textContent = (obj.planningHorizon && obj.planningHorizon.start) ? obj.planningHorizon.start.substring(0,10) : '';
	document.getElementById('Detail').getElementsByClassName('EndDate')[0].getElementsByClassName('Value')[0].textContent = (obj.planningHorizon && obj.planningHorizon.end) ? obj.planningHorizon.end.substring(0,10) : '';
}